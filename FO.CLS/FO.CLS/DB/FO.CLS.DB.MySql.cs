...
namespace FO.CLS.DB
{
    public class MySQL
    {
        ...
        // DB NAME 설정명                        
        public const string SET_NAME_DB_NAME     = "DB";
        ...
        {
            PREFIX = prefix;
            SQLITEINI xml = new SQLITEINI(PREFIX);

            IP = xml.ReadValue( SET_NAME_DB_IP);
            PORT = xml.ReadValue( SET_NAME_DB_PORT);
            DBNAME = xml.ReadValue( SET_NAME_DB_NAME);
            ID = xml.ReadValue( SET_NAME_DB_ID);
            PW = xml.ReadValue( SET_NAME_DB_PASSWORD);
        ...
        public MySQL(string ip, string port, string dbname, string id, string pw)
        {
            IP = ip;
            PORT = port;
            DBNAME = dbname;
        ...
        public void saveSet()
        {
            ...
            xml.WriteValue( SET_NAME_DB_IP, IP);
            xml.WriteValue( SET_NAME_DB_PORT, PORT);
            xml.WriteValue( SET_NAME_DB_NAME, DBNAME);
            xml.WriteValue( SET_NAME_DB_ID, ID);
            xml.WriteValue( SET_NAME_DB_PASSWORD, PW);
        }
        #endregion 
