...
namespace FO.CLS.DB
{
    public class MsSql
    {
        ...
        public MsSql(string prefix = "")
        {
            ...
            IP = xml.ReadValue("IP", "");
            PORT = xml.ReadValue("PORT", "");
            DBNAME = xml.ReadValue("DB", "");
            ID = xml.ReadValue("ID", "");
            PW = xml.ReadValue("PW", "");
            QUERYTIMEOUT = Convert.ToInt32(xml.ReadValue("TIMEOUT", "300"));
        ...
        public void saveSet()
        {
            ...
            xml.WriteValue("PORT", PORT);
            xml.WriteValue("DB", DBNAME);
            xml.WriteValue("ID", ID);
            xml.WriteValue("PW", PW);
            xml.WriteValue("TIMEOUT", QUERYTIMEOUT.ToString());
        }
